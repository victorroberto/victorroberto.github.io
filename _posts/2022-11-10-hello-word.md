...
<img src="{{ "/assets/img/hello-world/hello.png" | prepend: site.baseurl | prepend: site.url}}" alt="hello" />
...
<img src="{{ "/assets/img/hello-world/ate-mais.gif" | prepend: site.baseurl | prepend: site.url}}" alt="ate-mais" />